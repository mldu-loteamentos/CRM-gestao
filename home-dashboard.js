        ...
        setTimeout(() => {
            if (box && textEl) {
                const playPhrases = [
                    ...
                    "Será que a meta de hoje já foi batida? 🤔",
                    "Bora ligar pra aquele cliente que tá sumido? 📞",
                    ...
                    "E aí, quem vai ganhar a partida de Uno? 🃏",
                    "Tô fazendo meu cardio do dia! 🏃‍♂️",
                    "Mais rápido que eu, só o cliente fugindo da cobrança! 🏃",
                    "Fica tranquilo(a), o Israel tá em reunião, pode clicar! 🤫",
                    "Estou indo atrás do dinheiro que sumiu! 💵",
                    "Vou ali pegar um café e já volto! ☕",
                    ...
                    "Acho que a Ju tá de olho em nós... disfarça! 🫣",
                    ...
                    "Se tiver bolo na copa, me avisa! 🍰",
